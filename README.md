...
Если вы спросите меня, "на что похожи программирование, анализ данных и машинное обучение"? Я скажу вам, что всё это напоминает популярную игру "Factorio"!
...
2. Другой момент - анализ. Достаточно ли производится патронов? Приходится часто смотреть на графики потребления и производства! Если что-то простаивает, то это нужно исправлять, потому что ресурсы ограничены.
